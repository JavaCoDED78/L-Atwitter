...
import static com.gmail.javacoded78.constants.WebsocketConstants.TOPIC_FEED_VOTE;
import static com.gmail.javacoded78.constants.WebsocketConstants.TOPIC_TWEET_VOTE;
import static com.gmail.javacoded78.constants.WebsocketConstants.TOPIC_USER_ADD_TWEET;
import static com.gmail.javacoded78.constants.WebsocketConstants.TOPIC_USER_VOTE_TWEET;
...
public class PollController {
    ...
    public ResponseEntity<TweetResponse> voteInPoll(@RequestBody VoteRequest voteRequest) {
        ...
        webSocketClient.send(TOPIC_USER_VOTE_TWEET + tweet.getUser().getId(), tweet);
        return ResponseEntity.ok(tweet);
    }
}
