...
public class TweetControllerTest {
    ...
    public void getTweetAdditionalInfoById() throws Exception {
        mockMvc.perform(get(UI_V1_TWEETS + TWEET_ID_INFO, 43)
                ...
                .andExpect(jsonPath("$.user.username").value(TestConstants.FULL_NAME))
    ...
    public void getFollowersTweets() throws Exception {
        mockMvc.perform(get(UI_V1_TWEETS + FOLLOWER)
                ...
                .andExpect(jsonPath("$[6].text").value(TestConstants.YOUTUBE_LINK))
                ...
                .andExpect(jsonPath("$[6].link").value(TestConstants.YOUTUBE_LINK))
                .andExpect(jsonPath("$[6].linkTitle").value(TestConstants.YOUTUBE_LINK_TITLE))
                .andExpect(jsonPath("$[6].linkDescription").isEmpty())
                .andExpect(jsonPath("$[6].linkCover").value(TestConstants.YOUTUBE_LINK_COVER))
