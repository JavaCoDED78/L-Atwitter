...
class RetweetServiceImplTest {
    ...
    @Test
    void getUserRetweetsAndReplies_ShouldUserIdNotFound() {
    ...
    @Test
    void getUserRetweetsAndReplies_ShouldUserNotFound() {
        when(userClient.isUserExists(1L)).thenReturn(true);
    ...
    @Test
    void getUserRetweetsAndReplies_ShouldUserProfileBlocked() {
        when(userClient.isUserExists(1L)).thenReturn(true);
        when(userClient.isUserHavePrivateProfile(1L)).thenReturn(false);
    ...
    @Test
    void getRetweetedUsersByTweetId_ShouldTweetNotFound() {
    ...
    @Test
    void getRetweetedUsersByTweetId_ShouldTweetDeleted() {
    ...
    @Test
    void getRetweetedUsersByTweetId_ShouldUserNotFound() {
    ...
    @Test
    void getRetweetedUsersByTweetId_ShouldUserProfileBlocked() {
        tweet.setAuthorId(1L);
        when(tweetRepository.findById(TestConstants.TWEET_ID)).thenReturn(Optional.of(tweet));
        when(userClient.isUserHavePrivateProfile(1L)).thenReturn(false);
        when(userClient.isMyProfileBlockedByUser(1L)).thenReturn(true);
    ...
    void retweet_ShouldRetweet() {
        ...
        verify(tweetRepository, times(1)).findById(TestConstants.TWEET_ID);
        verify(retweetRepository, times(1)).isTweetRetweeted(TestConstants.USER_ID, TestConstants.TWEET_ID);
        verify(retweetRepository, times(1)).save(Retweet.builder()
    ...
    @Test
    void retweet_ShouldTweetNotFound() {
        when(tweetRepository.findById(TestConstants.TWEET_ID)).thenReturn(Optional.empty());
        ApiRequestException exception = assertThrows(ApiRequestException.class,
    ...
    @Test
    void retweet_ShouldTweetDeleted() {
        tweet.setDeleted(true);
        when(tweetRepository.findById(TestConstants.TWEET_ID)).thenReturn(Optional.of(tweet));
        ApiRequestException exception = assertThrows(ApiRequestException.class,
                () -> retweetService.retweet(TestConstants.TWEET_ID));
    ...
    @Test
    void retweet_ShouldUserNotFound() {
        tweet.setAuthorId(1L);
        when(tweetRepository.findById(TestConstants.TWEET_ID)).thenReturn(Optional.of(tweet));
        when(userClient.isUserHavePrivateProfile(1L)).thenReturn(true);
        ApiRequestException exception = assertThrows(ApiRequestException.class,
    ...
    @Test
    void retweet_ShouldUserProfileBlocked() {
        tweet.setAuthorId(1L);
        when(tweetRepository.findById(TestConstants.TWEET_ID)).thenReturn(Optional.of(tweet));
        when(userClient.isUserHavePrivateProfile(1L)).thenReturn(false);
        when(userClient.isMyProfileBlockedByUser(1L)).thenReturn(true);
