...
export const setUserTweets = (payload: {
...
export const setAddedUserTweet = (
  payload: Tweet
): SetAddedUserTweetActionInterface => ({
...
export const setUpdatedUserTweet = (
  payload: Tweet
): SetUpdatedUserTweetActionInterface => ({
...
export const fetchUserTweets = (payload: {
  userId: string;
  page: number;
}): FetchUserTweetsActionInterface => ({
...
export const fetchUserLikedTweets = (payload: {
  userId: string;
  page: number;
}): FetchUserLikedTweetsActionInterface => ({
...
export const fetchUserMediaTweets = (payload: {
  userId: string;
  page: number;
}): FetchUserMediaTweetsActionInterface => ({
...
export const fetchUserRetweetsAndReplies = (payload: {
  userId: string;
  page: number;
}): FetchUserRetweetsAndRepliesActionInterface => ({
...
export const setUserTweetsLoadingStatus = (
