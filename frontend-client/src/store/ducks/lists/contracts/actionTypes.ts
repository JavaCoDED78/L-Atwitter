...
export interface SetUnfollowListActionInterface
  extends Action<ListsActionType> {
...
export interface FetchUserListsByIdActionInterface
  extends Action<ListsActionType> {
  type: ListsActionType.FETCH_USER_LISTS_BY_ID;
  payload: string;
}

export interface FetchTweetListsWhichUserInActionInterface
  extends Action<ListsActionType> {
  type: ListsActionType.FETCH_TWEET_LISTS_WHICH_USER_IN;
}

export interface FetchPinnedListsActionInterface
  extends Action<ListsActionType> {
...
export interface ProcessListMemberActionInterface
  extends Action<ListsActionType> {
...
export interface SetPinedListToUserListActionInterface
  extends Action<ListsActionType> {
  type: ListsActionType.SET_PINED_LIST_TO_USER_LIST;
  payload: Lists;
}

export interface ResetListsStateActionInterface
  extends Action<ListsActionType> {
