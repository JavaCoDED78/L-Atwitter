...
export interface SetTweetDataLoadingStateInterface
  extends Action<TweetActionType> {
...
export interface FetchReplyTweetActionInterface
  extends Action<TweetActionType> {
  type: TweetActionType.FETCH_REPLY_TWEET;
  payload: ReplyTweet;
}

export interface DeleteTweetReplyActionInterface
  extends Action<TweetActionType> {
