...
export interface SetNotificationsActionInterface
  extends Action<NotificationsActionsType> {
  type: NotificationsActionsType.SET_NOTIFICATIONS;
  payload: Notifications;
}

export interface FetchNotificationsActionInterface
  extends Action<NotificationsActionsType> {
  type: NotificationsActionsType.FETCH_NOTIFICATIONS;
}

export interface FetchNotificationsFromTweetAuthorsActionInterface
  extends Action<NotificationsActionsType> {
