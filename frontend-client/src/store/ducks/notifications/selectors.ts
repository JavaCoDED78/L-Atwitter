...
export const selectNotificationsList = (state: RootState) =>
  selectNotifications(state).notificationsList;
export const selectNotificationsTweetAuthors = (state: RootState) =>
  selectNotifications(state).tweetAuthors;
export const selectLoadingState = (state: RootState): LoadingStatus =>
  selectNotifications(state).loadingState;
