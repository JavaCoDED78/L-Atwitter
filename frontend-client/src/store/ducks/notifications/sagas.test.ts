...
describe("notificationsSaga:", () => {
  describe("fetchNotificationsRequest:", () => {
    ...
    testSetResponse({
      worker: worker,
      mockData: mockNotificationsResponse,
  ...
  describe("fetchNotificationsFromTweetAuthorsRequest:", () => {
    ...
    const worker = fetchNotificationsFromTweetAuthorsRequest(
      fetchNotificationsFromTweetAuthors(1)
    );
  ...
  describe("fetchNotificationInfoRequest:", () => {
    ...
    testSetResponse({
      worker: worker,
      mockData: mockNotificationInfoResponse,
      action: setNotificationInfo,
      payload: mockNotificationInfoResponse,
      responseType: "NotificationInfoResponse",
    });
    testLoadingStatus(
      worker,
      setNotificationsLoadingState,
  ...
  testWatchSaga(notificationsSaga, [
    {
      actionType: NotificationsActionsType.FETCH_NOTIFICATIONS,
      workSaga: fetchNotificationsRequest,
    },
    {
      actionType:
    ...
    {
      actionType: NotificationsActionsType.FETCH_NOTIFICATION_INFO,
      workSaga: fetchNotificationInfoRequest,
    },
  ]);
});
