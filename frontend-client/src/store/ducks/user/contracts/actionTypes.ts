...
export interface AddTweetToBookmarksActionInterface
  extends Action<UserActionsType> {
...
export interface FetchReadMessagesActionInterface
  extends Action<UserActionsType> {
  type: UserActionsType.FETCH_READ_MESSAGES;
  payload: number;
}

export interface SetUnreadMessageActionInterface
  extends Action<UserActionsType> {
  type: UserActionsType.SET_UNREAD_MESSAGE;
  payload: ChatMessage;
}

export interface SetNewNotificationActionInterface
  extends Action<UserActionsType> {
