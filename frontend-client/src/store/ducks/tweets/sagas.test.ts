...
describe("tweetsSaga:", () => {
  ...
  describe("fetchTweetsRequest:", () => {
    ...
    testSetResponse({
      worker: worker,
      mockData: mockPageableTweets,
      action: setPageableTweets,
      payload: {
  ...
  describe("fetchTweetsByListIdRequest:", () => {
    const worker = fetchTweetsByListIdRequest(
      fetchTweetsByListId({ listId: 1, pageNumber: 1 })
    );
  ...
  describe("updateScheduledTweetRequest:", () => {
    const worker = updateScheduledTweetRequest(
      updateScheduledTweet(mockAddTweet)
    );
  ...
  describe("deleteScheduledTweetsTweetRequest:", () => {
    const worker = deleteScheduledTweetsTweetRequest(
      deleteScheduledTweets({ tweetsIds: [1, 2, 3] })
    );
  ...
  testWatchSaga(tweetsSaga, [
    ...
    {
      actionType: TweetsActionType.FETCH_MEDIA_TWEETS,
      workSaga: fetchMediaTweetsRequest,
    },
    {
      actionType: TweetsActionType.FETCH_TWEETS_WITH_VIDEO,
      workSaga: fetchTweetsWithVideoRequest,
    },
    {
      actionType: TweetsActionType.FETCH_FOLLOWERS_TWEETS,
      workSaga: fetchFollowersTweetsRequest,
    },
    ...
    {
      actionType: TweetsActionType.ADD_SCHEDULED_TWEET,
      workSaga: addScheduledTweetRequest,
    },
    {
      actionType: TweetsActionType.UPDATE_SCHEDULED_TWEET,
      workSaga: updateScheduledTweetRequest,
    },
    {
      actionType: TweetsActionType.ADD_QUOTE_TWEET,
      workSaga: addQuoteTweetRequest,
    },
    { actionType: TweetsActionType.VOTE, workSaga: voteRequest },
    {
      actionType: TweetsActionType.CHANGE_REPLY_TYPE,
      workSaga: changeReplyTypeRequest,
    },
    {
      actionType: TweetsActionType.FETCH_DELETE_TWEET,
      workSaga: fetchDeleteTweetRequest,
    },
    {
      actionType: TweetsActionType.DELETE_SCHEDULED_TWEETS,
      workSaga: deleteScheduledTweetsTweetRequest,
    },
    ...
    {
      actionType: TweetsActionType.FETCH_TWEETS_BY_TAG,
      workSaga: fetchTweetsByTagRequest,
    },
    {
      actionType: TweetsActionType.FETCH_TWEETS_BY_TEXT,
      workSaga: fetchTweetsByTextRequest,
    },
    {
      actionType: TweetsActionType.FETCH_TWEETS_BY_LIST_ID,
      workSaga: fetchTweetsByListIdRequest,
    },
    {
      actionType: TweetsActionType.FETCH_BOOKMARKS,
      workSaga: fetchUserBookmarksRequest,
    },
  ]);
});
