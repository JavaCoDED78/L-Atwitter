...
export const addScheduledTweet = (
  payload: AddTweet
): AddScheduledTweetActionInterface => ({
...
export const changeReplyType = (payload: {
  tweetId: string;
  replyType: ReplyType;
}): ChangeReplyTypeActionInterface => ({
...
export const deleteScheduledTweets = (payload: {
  tweetsIds: number[];
}): DeleteScheduledTweetsActionInterface => ({
