...
export interface AddScheduledTweetActionInterface
  extends Action<TweetsActionType> {
  type: TweetsActionType.ADD_SCHEDULED_TWEET;
  payload: AddTweet;
}

export interface UpdateScheduledTweetActionInterface
  extends Action<TweetsActionType> {
...
export interface ChangeReplyTypeActionInterface
  extends Action<TweetsActionType> {
  type: TweetsActionType.CHANGE_REPLY_TYPE;
  payload: { tweetId: string; replyType: ReplyType };
}

export interface SetUpdatedTweetActionInterface
  extends Action<TweetsActionType> {
  type: TweetsActionType.SET_UPDATED_TWEET;
  payload: Tweet;
}

export interface FetchDeleteTweetActionInterface
  extends Action<TweetsActionType> {
  type: TweetsActionType.FETCH_DELETE_TWEET;
  payload: string;
}

export interface DeleteScheduledTweetsActionInterface
  extends Action<TweetsActionType> {
...
export interface FetchTweetsByTextActionInterface
  extends Action<TweetsActionType> {
