...
export interface SetUserProfileActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.SET_USER;
  payload: User;
}

export interface UpdateUserDataActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.UPDATE_USER_DATA;
  payload: User;
}

export interface FetchUserProfileActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.FETCH_USER;
  payload: string;
}

export interface ResetUserProfileActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.RESET_USER;
}

export interface FollowProfileActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.FOLLOW;
  payload: User;
}

export interface UnfollowProfileActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.UNFOLLOW;
  payload: User;
}

export interface FollowUserProfileActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.FOLLOW_USER;
  payload: User;
}

export interface UnfollowUserProfileActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.UNFOLLOW_USER;
  payload: User;
}

export interface ProcessSubscribeActionInterface
  extends Action<UserProfileActionsType> {
  type: UserProfileActionsType.PROCESS_SUBSCRIBE;
  payload: number;
}

export interface SetUserProfileLoadingStatusActionInterface
  extends Action<UserProfileActionsType> {
