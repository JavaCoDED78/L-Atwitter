      ...
      >
        <div className={classes.dropdown}>
          <div className={classes.infoWrapper}>
            <div className={classes.title}>Who can reply?</div>
          ...
          <List component="nav" aria-label="main mailbox folders">
            ...
            >
              <div className={classes.iconCircle}>
                <span className={classes.icon}>{FollowReplyOutlinedIcon}</span>
              </div>
            ...
            >
              <div className={classes.iconCircle}>
                <span className={classes.icon}>{MentionReplyOutlinedIcon}</span>
              </div>
