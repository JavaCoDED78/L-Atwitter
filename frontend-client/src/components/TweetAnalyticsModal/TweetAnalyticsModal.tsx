      ...
      <DialogContent>
        <div className={classes.tweetInfoContainer}>
          <div className={classes.tweetInfoWrapper}>
            <Typography
              className={classes.tweetInfoFullName}
              component={"span"}
            >
              {tweet.user.fullName}
            </Typography>
            <Typography
              className={classes.tweetInfoUsername}
              component={"span"}
            >
              @{tweet.user.username}
            </Typography>
          ...
          <div className={classes.analyticsInfoWrapper}>
            <Typography
              className={classes.analyticsInfoTitle}
              component={"div"}
            >
              Impressions
            ...
            <div className={classes.engagementsWrapper}>
              ...
              <Typography
                className={classes.analyticsInfoText}
                component={"div"}
              >
          ...
          <div className={classes.promoteWrapper}>
            <img
              className={classes.promoteImage}
