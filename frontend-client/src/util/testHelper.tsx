...
export const mockLocation = (
  mockLocationState: { tag: string } | { text: string }
): void => {
...
export const mockListsOwnerMemberResponse = [
  { id: 1 },
  { id: 2 },
] as ListsOwnerMemberResponse[];
export const mockMutedUserResponse = [
  { id: 1 },
  { id: 2 },
] as MutedUserResponse[];
export const mockBlockedUserResponse = [
  { id: 1 },
  { id: 2 },
...
export const mockListUserResponse = [
  { id: 1 },
  { id: 2 },
] as ListUserResponse[];
export const mockPinnedListResponse = [
  { id: 1 },
  { id: 2 },
] as PinnedListResponse[];
export const mockSimpleListResponse = [
  { id: 1 },
  { id: 2 },
...
export const mockNotificationUserResponse = [
  { id: 1 },
  { id: 1 },
] as NotificationUserResponse[];
export const mockNotificationInfoResponse = {
  id: 1,
...
export const mockTweetImageResponse = [
  { tweetId: 1, imageId: 1 },
  { tweetId: 2, imageId: 2 },
