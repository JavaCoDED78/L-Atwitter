  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={classes.title}>We sent you a code</div>
        <div className={classes.text}>Enter it below to verify {email}.</div>
        ...
        <div className={classes.link}>Didn't receive email?</div>
        <Button
          style={{ marginTop: 320 }}
