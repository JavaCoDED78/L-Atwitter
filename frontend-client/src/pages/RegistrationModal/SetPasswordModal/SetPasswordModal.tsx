...
const SetPasswordModal: FC<SetPasswordProps> = ({
  email,
  open,
  onClose,
}): ReactElement => {
  ...
  const onSubmit = (data: PasswordFormProps): void => {
    const registrationData: RegistrationProps = {
      email: email,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={classes.title}>You'll need a password</div>
        <div className={classes.text}>Make sure it’s 8 characters or more.</div>
