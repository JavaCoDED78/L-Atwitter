    ...
    <div className={classes.container}>
      ...
      <div className={classes.content}>
        <Route
          exact
          path="/account/forgot"
          component={() => <FindEmail email={email} setEmail={setEmail} />}
        />
        <Route
          exact
          path="/account/forgot/send_password_reset"
          component={() => <ResetPasswordOption email={email} />}
        />
        <Route
          exact
          path="/account/forgot/confirm_pin_reset"
          component={() => <CheckEmailCode setUser={setUser} />}
        />
        <Route
          exact
          path="/account/forgot/reset_password"
          component={() => <ResetPassword user={user} />}
        />
        <Route
          exact
          path="/account/forgot/password_reset_complete"
