...
const ResetPasswordSuccess: FC = (): ReactElement => {
  ...
  return (
    <>
      ...
      <div>
        Take a moment to review the applications that have access to your
        account. Revoke those you don't recognize or no longer use.
      </div>
      <div className={classes.successHeader}>
        Add a phone number to your account
      </div>
      <div style={{ marginBottom: 48 }}>
        This makes it easy to get back into your account if you're ever locked
        out.
      </div>
