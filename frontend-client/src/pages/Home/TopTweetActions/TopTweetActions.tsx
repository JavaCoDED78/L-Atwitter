...
const TopTweetActions: FC<TopTweetActionsProps & HoverActionProps> = ({
  ...
  const [openTopTweetActions, setOpenTopTweetActions] =
      ...
      <div>
        ...
        {!openTopTweetActions ? null : (
          <div className={classes.dropdown}>
            ...
            <List>
              <ListItem
                onClick={switchTweets ? handleTopTweets : handleLatestTweets}
              >
              ...
              <Link
                to={"/settings/content_preferences"}
                className={globalClasses.linkWrapper}
              >
                <ListItem>
                  <div className={classes.listItemWrapper}>
