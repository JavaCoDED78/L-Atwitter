...
const PopperListWindow: FC<PopperListWindowProps> = ({
  list,
}): ReactElement => {
  ...
  const onOpenMembersModalWindow = (
  ...
  const onOpenFollowersModalWindow = (
    event: React.MouseEvent<HTMLSpanElement, MouseEvent>
  ): void => {
    event.preventDefault();
    event.stopPropagation();
    ...
    <div className={classes.popperListWindow}>
      ...
      <div className={classes.popperListInfo}>
        ...
        <Link
          ...
          className={classes.popperListOwnerLink}
        >
        ...
        <div className={classes.buttonWrapper}>
          {myProfile?.id === list?.listOwner.id ? null : follower ? (
            <Button
