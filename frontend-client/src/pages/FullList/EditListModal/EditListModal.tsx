...
const EditListModal: FC<EditListModalProps> = ({
  visible,
  onClose,
}): ReactElement | null => {
  ...
  const [visibleManageMembersModal, setVisibleManageMembersModal] =
    useState<boolean>(false);
  const [visibleDeleteListModal, setVisibleDeleteListModal] =
    useState<boolean>(false);
