    ...
    <>
      ...
      <div className={classes.listWrapper}>
        <List component="nav" aria-label="main mailbox folders">
          <ListItem>
            <div className={classes.icon}>{AccessibilityIcon}</div>
            <div>
          ...
          <ListItem>
            <div className={classes.icon}>{DisplayIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Display
              </Typography>
          ...
          <ListItem>
            <div className={classes.icon}>{LanguagesIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Languages
              </Typography>
          ...
          <ListItem>
            <div className={classes.icon}>{TweetActivityIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Data usage
              </Typography>
              <Typography component={"div"} className={classes.text}>
                Limit how Twitter uses some of your network data. These settings
                affect all the Twitter accounts on this browser.
              </Typography>
            </div>
            <div className={classes.arrowIcon}>{ArrowRightIcon}</div>
