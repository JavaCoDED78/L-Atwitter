    ...
    <>
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          ...
          Twitter. You can turn them off anytime.
        </Typography>
      </div>
      <div className={classes.connectedAppsWrapper}>
        ...
        <Typography component={"div"} className={classes.subtitle}>
          To receive notifications as they happen, turn on push notifications.
          You’ll also receive them when you’re not on Twitter. Turn them off
          anytime.
        </Typography>
      </div>
    </>
