    ...
    <>
      <List>
        ...
        <div className={classes.title}>
          <Typography component={"span"}>Display language</Typography>
        </div>
        <div className={classes.text}>
          <Typography component={"span"}>
        ...
        <div className={classes.text}>
          <Typography component={"span"}>
            Select additional languages for the content you want to see on
            Twitter.
          </Typography>
        </div>
        <ListItem>
        ...
        <div className={classes.divider} />
        <div className={classes.title}>
          <Typography component={"span"}>Languages you may know</Typography>
        </div>
        <div className={classes.text}>
          <Typography component={"span"}>
            Manage the languages Twitter inferred based on your activity, such
            as the accounts you follow and the Tweets you engage with.
          </Typography>
        </div>
        <ListItem>
          <div>
