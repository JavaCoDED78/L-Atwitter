  ...
  return (
    <>
      <Typography className={classes.text}>
        ...
        based on your Twitter profile and activity. Age information is used to
        personalize your experience.{" "}
        <a
          href={
            "https://help.twitter.com/safety-and-security/birthday-visibility-settings"
          }
          target="_blank"
      ...
      <Typography className={classes.text}>13-64</Typography>
      <div className={classes.divider} />
      <Typography className={classes.text}>
