    ...
    <div className={classes.deactivateAccountWrapper}>
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          You’re about to start the process of deactivating your Twitter
          account. Your display name, @username, and public profile will no
          longer be viewable on Twitter.com, Twitter for iOS, or Twitter for
          Android.
        </Typography>
      </div>
      <div className={classes.infoItemWrapper}>
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          You can restore your Twitter account if it was accidentally or
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          ...
          <a
            href={
              "https://help.twitter.com/safety-and-security/remove-twitter-profile-from-google-search"
            }
            target="_blank"
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          If you want to download your Twitter data, you’ll need to complete
          both the request and download process before deactivating your
          account. Links to download your data cannot be sent to deactivated
          accounts.
        </Typography>
      </div>
      <div className={classes.divider} />
      <div className={classes.deleteUser}>
        <Typography component={"span"}>Deactivate</Typography>
      </div>
    </div>
  );
};
