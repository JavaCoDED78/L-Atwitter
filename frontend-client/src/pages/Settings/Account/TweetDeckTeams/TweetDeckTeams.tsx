...
import { Paper, Radio, Switch, Typography } from "@material-ui/core";
        ...
        <div className={classes.infoWrapper}>
          <div className={classes.infoItemWrapper}>
            <Typography component={"div"} className={classes.text}>
              Invite anyone to Tweet from this account using the Teams feature
              in TweetDeck.
            </Typography>
          </div>
          <div className={classes.infoItemWrapper}>
            ...
            <Typography component={"div"} className={classes.text}>
              When this setting is on, you can invite anyone to Tweet from this
              account using TweetDeck Teams.{" "}
              <a
