      ...
      <Grid className={classes.grid} md={5} item>
        <Paper className={classes.rightSideHeader}>
          ...
          <Route exact path="/settings/info/languages">
            <BackButton />
            <Typography variant="h6">Change display language</Typography>
          </Route>
          ...
          <Route exact path="/settings/privacy_and_safety/content_you_see">
            <BackButton />
            <Typography variant="h6">Content you see</Typography>
          </Route>
          <Route exact path="/settings/privacy_and_safety/mute_and_block">
            <BackButton />
            <Typography variant="h6">Mute and block</Typography>
          </Route>
          ...
          <Route exact path="/settings/privacy_and_safety/muted">
            <BackButton />
            <Typography variant="h6">Muted accounts</Typography>
          </Route>
          <Route exact path="/settings/privacy_and_safety/muted_keywords">
            <BackButton />
            <Typography variant="h6">Muted words</Typography>
          </Route>
          <Route exact path="/settings/privacy_and_safety/advanced_filters">
            <BackButton />
            <Typography variant="h6">Muted notifications</Typography>
          </Route>
          ...
          <Route exact path="/settings/privacy_and_safety/contacts">
            <BackButton />
            <Typography variant="h6">Discoverability and contacts</Typography>
          </Route>
          ...
          <Route exact path="/settings/privacy_and_safety/ads_preferences">
            <BackButton />
            <Typography variant="h6">Ads preferences</Typography>
          </Route>
          <Route exact path="/settings/privacy_and_safety/audiences">
            <BackButton />
            <Typography variant="h6">Your advertiser list</Typography>
          </Route>
          <Route exact path="/settings/privacy_and_safety/off_twitter_activity">
            <BackButton />
            <Typography variant="h6">Off-Twitter activity</Typography>
          </Route>
          <Route
            exact
            path="/settings/privacy_and_safety/data_sharing_with_business_partners"
          >
            <BackButton />
            <Typography variant="h6">
          ...
          <Route exact path="/settings/privacy_and_safety/locations">
            <BackButton />
            <Typography variant="h6">See places you’ve been</Typography>
          </Route>
          ...
          <Route
            exact
            path="/settings/accessibility_display_and_languages/accessibility"
          >
            <BackButton />
          ...
          <Route
            exact
            path="/settings/accessibility_display_and_languages/display"
          >
            <BackButton />
          ...
          <Route
            exact
            path="/settings/accessibility_display_and_languages/languages"
          >
            <BackButton />
          ...
          <Route
            exact
            path="/settings/accessibility_display_and_languages/data"
          >
            <BackButton />
          ...
          <Route
            exact
            path="/settings/accessibility_display_and_languages/autoplay"
          >
            <BackButton />
        ...
        <div className={classes.pageContainer}>
          <Paper variant="outlined">
            <div className={classes.pageInfoWrapper}>
              ...
              <Route
                exact
                path="/settings/privacy_and_safety/tagging"
                component={PhotoTagging}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/your_tweets"
                component={YourTweets}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/location"
                component={LocationInformation}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/content_you_see"
                component={ContentYouSee}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/mute_and_block"
                component={MuteAndBlock}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/blocked"
                component={BlockedAccounts}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/muted"
                component={MutedAccounts}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/muted_keywords"
                component={MutedWords}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/advanced_filters"
              ...
              <Route
                exact
                path="/settings/privacy_and_safety/spaces"
                component={Spaces}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/contacts"
                component={Discoverability}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/contacts_dashboard"
                component={ManageContacts}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/ads_preferences"
                component={AdsPreferences}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/audiences"
                component={YourAdvertiserList}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/off_twitter_activity"
              ...
              <Route
                exact
                path="/settings/privacy_and_safety/location_information"
                component={Location}
              />
              <Route
                exact
                path="/settings/privacy_and_safety/locations"
                component={Places}
              />
              <Route
                exact
              ...
              <Route
                exact
                path="/settings/notification/filters"
                component={Filters}
              />
              <Route
                exact
              ...
              <Route
                exact
                path="/settings/notification/push_notifications"
                component={PushNotifications}
              />
              <Route
                exact
                path="/settings/notification/email_notifications"
