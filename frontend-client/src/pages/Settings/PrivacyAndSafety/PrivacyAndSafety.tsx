      ...
      <div className={classes.listWrapper}>
        <List component="nav" aria-label="main mailbox folders">
          <Link to={"/settings/privacy_and_safety/audience"}>
            <ListItem>
              <div className={classes.icon}>{AudienceIcon}</div>
              <div>
          ...
          <ListItem>
            <div className={classes.icon}>{QuoteTweetIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Your Tweets
              </Typography>
          ...
          <ListItem>
            <div className={classes.icon}>{ContentIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Content you see
              </Typography>
              <Typography component={"div"} className={classes.text}>
                Decide what you see on Twitter based on your preferences like
          ...
          <ListItem>
            <div className={classes.icon}>{MuteIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Mute and block
              </Typography>
              <Typography component={"div"} className={classes.text}>
                Manage the accounts, words, and notifications that you’ve muted
                or blocked.
              </Typography>
            </div>
            <div className={classes.arrowIcon}>{ArrowRightIcon}</div>
          ...
          <ListItem>
            <div className={classes.icon}>{SpacesIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Spaces
              </Typography>
          ...
          <ListItem>
            <div className={classes.icon}>{DiscoverIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
          ...
          <ListItem>
            <div className={classes.icon}>{AdsIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Ads preferences
              </Typography>
          ...
          <ListItem>
            <div className={classes.icon}>{OffTwitterIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Off-Twitter activity
              </Typography>
              <Typography component={"div"} className={classes.text}>
                Manage how Twitter uses your online activity outside of Twitter,
          ...
          <ListItem>
            <div className={classes.icon}>{DataSharingIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Data sharing with business partners
              </Typography>
              <Typography component={"div"} className={classes.text}>
                Allow sharing of additional information with Twitter’s business
                partners.
              </Typography>
            </div>
            <div className={classes.arrowIcon}>{ArrowRightIcon}</div>
          ...
          <ListItem>
            <div className={classes.icon}>{LocationIcon}</div>
            <div>
              <Typography component={"div"} className={classes.subtitle}>
                Location information
              </Typography>
              <Typography component={"div"} className={classes.text}>
                Manage the location information Twitter uses to personalize your
                experience.
              </Typography>
            </div>
            <div className={classes.arrowIcon}>{ArrowRightIcon}</div>
          ...
          <a href="https://privacy.twitter.com/" target={"_blank"}>
            <ListItem>
              ...
              <div className={classes.arrowIcon}>{ArrowTopIcon}</div>
            </ListItem>
          </a>
