    ...
    <>
      <div className={classes.mutedWordsInfo}>
        ...
        <Typography component={"div"} className={classes.subTitle}>
          When you mute words, you won’t get any new notifications for Tweets
          that include them or see Tweets with those words in your timeline.
          <a
            href={
              "https://help.twitter.com/using-twitter/advanced-twitter-mute-options"
            }
            target="_blank"
