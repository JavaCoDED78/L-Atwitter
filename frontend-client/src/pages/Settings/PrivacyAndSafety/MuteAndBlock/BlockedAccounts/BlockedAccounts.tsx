    ...
    <>
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          ...
          <a
            href={
              "https://help.twitter.com/using-twitter/blocking-and-unblocking-accounts"
            }
            target="_blank"
      ...
      {isUsersLoading ? (
        ...
        <div className={classes.blockedAccountsInfo}>
          ...
          <Typography component={"div"} className={classes.subTitle}>
            {activeTab === 0 ? (
              <>
                When you block someone, that person won’t be able to follow or
              ...
              <>
                ...
                <a
                  href={
                    "https://help.twitter.com/using-twitter/advanced-twitter-block-options"
                  }
                  target="_blank"
                  className={classes.link}
                >
        ...
        blockedUsers.map((blockedUser) => (
          <BlockedAccountItem blockedUser={blockedUser} />
        ))
      )}
    </>
  );
