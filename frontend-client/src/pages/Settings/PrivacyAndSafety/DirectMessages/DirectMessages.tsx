  ...
  return (
    <>
      ...
      <div className={classes.infoItemWrapper}>
        ...
        <Typography component={"div"} className={classes.text}>
          Let people who you don’t follow send you message requests and add you
          to group conversations. To reply to their messages, you need to accept
          the request.{" "}
          <a
            href={
              "https://help.twitter.com/using-twitter/direct-messages#receive"
            }
            target="_blank"
      ...
      <div className={classes.infoItemWrapper}>
        ...
        <Typography component={"div"} className={classes.text}>
          ...
          <a
            href={
              "https://help.twitter.com/using-twitter/direct-messages#receipts"
            }
            target="_blank"
            className={classes.link}
          >
