    ...
    <>
      ...
      <div className={classes.infoItemWrapper}>
        ...
        <Typography component={"div"} className={classes.text}>
          ...
          <a
            href={
              "https://help.twitter.com/safety-and-security/email-and-phone-discoverability-settings"
            }
            target="_blank"
      ...
      <Link
        to={"/settings/privacy_and_safety/locations"}
        className={classes.adsPreferencesWrapper}
      >
        <div className={classes.adsPreferencesLink}>
          <Typography component={"span"}>See places you’ve been</Typography>
          {ArrowRightIcon}
        </div>
      </Link>
      <Link
        to={"/settings/privacy_and_safety/location"}
        className={classes.adsPreferencesWrapper}
      >
        <div className={classes.adsPreferencesLink}>
      ...
      <div className={classes.adsPreferencesLink}>
        <Typography component={"span"}>Explore settings</Typography>
        {ArrowRightIcon}
      </div>
    </>
  );
