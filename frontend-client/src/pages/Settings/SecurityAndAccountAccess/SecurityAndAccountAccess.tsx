          ...
          <div className={classes.listWrapper}>
            <List component="nav" aria-label="main mailbox folders">
              <Link to={"/settings/security"}>
                <ListItem>
                  <div className={classes.icon}>{SecurityIcon}</div>
                  <div>
              ...
              <Link to={"/settings/security/apps_and_sessions"}>
                <ListItem>
                  <div className={classes.icon}>{AppsIcon}</div>
                  <div>
                    <Typography component={"div"} className={classes.title}>
                      Apps and sessions
                    </Typography>
                    <Typography component={"div"} className={classes.text}>
                      ...
                      and the apps you connected to your account.
                    </Typography>
                  </div>
                  <div className={classes.arrowIcon}>{ArrowRightIcon}</div>
                </ListItem>
              ...
              <ListItem>
                <div className={classes.icon}>{ConnectedIcon}</div>
                <div>
                  <Typography component={"div"} className={classes.title}>
                    Connected accounts
                  </Typography>
