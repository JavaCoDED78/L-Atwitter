        ...
        <div className={classes.infoWrapper}>
          ...
          <div className={classes.infoItemWrapper}>
            ...
            <Typography component={"div"} className={classes.text}>
              ...
              authentication code to enter when you log in to Twitter.
            </Typography>
          </div>
          <div className={classes.infoItemWrapper}>
            <div className={classes.infoItem}>
            ...
            <Typography component={"div"} className={classes.text}>
              ...
              enter every time you log in to Twitter.
            </Typography>
          </div>
          <div className={classes.infoItemWrapper}>
            <div className={classes.infoItem}>
            ...
            <Typography component={"div"} className={classes.text}>
              Use a security key that inserts into your computer or syncs to
              your mobile device when you log in to Twitter. You’ll need to use
              a supported mobile device or web browser.{" "}
              <a
                href={
