        ...
        <div className={classes.infoWrapper}>
          ...
          <div className={classes.infoItemWrapper}>
            <Typography component={"div"} className={classes.text}>
              ...
              You can choose a text message, authentication app, or security
              key.{" "}
              <a
                href={
          ...
          <div className={classes.infoItemWrapper}>
            <Typography component={"div"} className={classes.text}>
              ...
              requiring additional information to reset your password. If
              enabled, you must provide either the phone number or email address
              associated with your account in order to reset your password.
            </Typography>
          </div>
          <div className={classes.infoItemWrapper}>
