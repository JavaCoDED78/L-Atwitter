    ...
    <>
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          Sessions are the devices you are using or that have used your Twitter
          account. These are the sessions where your account is currently logged
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          You’re logged into this Twitter account on this device and are
          currently using it.
        </Typography>
      </div>
      <Link
        ...
        <div className={classes.sessionLink}>
          <div className={classes.sessionInfo}>
            ...
            <div>
              ...
              <Typography component={"div"} className={classes.text}>
                {countryName} ·{" "}
                <span className={classes.active}>Active now</span>
              </Typography>
            </div>
          </div>
      ...
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          You’re logged into these accounts on these devices and aren’t
          currently using them.
        </Typography>
      </div>
      <div className={classes.infoItemWrapper}>
        <Typography component={"div"} className={classes.text}>
          Logging out will end 1 of your other active Twitter sessions. It won’t
          affect your current active session.{" "}
          <a
            href={
              "https://help.twitter.com/managing-your-account/connect-or-revoke-access-to-third-party-apps"
            }
            target="_blank"
