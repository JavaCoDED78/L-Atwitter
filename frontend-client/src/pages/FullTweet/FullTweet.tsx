...
const FullTweet: FC<HoverProps<Tweet> & FullTweetProps & HoverActionProps> = ({
  ...
  const [visibleAnalyticsModalWindow, setVisibleAnalyticsModalWindow] =
    ...
    return (
      <div style={{ paddingTop: 48 }}>
        ...
        <Paper className={classes.container}>
          ...
          <UsersListModal
            users={
              modalWindowTitle === "Liked by"
                ? tweetData.likedTweets
                : tweetData.retweets
            }
            title={
              modalWindowTitle === "Liked by" ? "Liked by" : "Retweeted by"
            }
