              ...
              <div className={classes.iconGroup}>
                <div className={classes.icon}>
                  <Link to={"/messages/settings"}>
                    <IconButton
                      onMouseEnter={() =>
                        handleHoverAction(MessagesAction.SETTINGS)
                      }
                ...
                <div className={classes.icon}>
                  <IconButton
                    ...
                    onMouseEnter={() =>
                      handleHoverAction(MessagesAction.NEW_MESSAGE)
                    }
                    onMouseLeave={handleLeaveAction}
                    color="primary"
                  >
                ...
                >
                  {chats.map((chat) => (
                    <ListItem
                      ...
                      id={
                        participant?.user.id === chat.participants[0].user.id!
                          ? "selected"
                          : ""
                      }
                      selected={
                  ...
                  <div className={classes.iconGroup}>
                    <div className={classes.icon}>
                      <Link to={`/messages/${participant.user.id}/info`}>
                        <IconButton
                          onMouseEnter={() =>
                            handleHoverAction(MessagesAction.DETAILS)
                          }
                          onMouseLeave={handleLeaveAction}
                          color="primary"
                        >
                            ...
                            <Link to={`/home/tweet/${message.tweet.id}`}>
                              <div className={classes.tweetWrapper}>
                                <div className={classes.tweetUserInfoWrapper}>
                                  ...
                                  <span className={classes.tweetUsername}>
                                    {formatDate(
                                      new Date(message.tweet?.dateTime!)
                                    )}
                                  </span>
                                </div>
                                <span>
                      ...
                      <React.Fragment key={message.id}>
                        <div className={classes.participantContainer}>
                          ...
                          <div>
                            {message.tweet && (
                              <div
                                className={classes.participantTweetContainer}
                              >
                                <Link to={`/home/tweet/${message.tweet.id}`}>
                                  <div
                                    className={classes.participantTweetWrapper}
                                  >
                                    <div
                                      className={
                                        classes.participantTweetInfoWrapper
                                      }
                                    >
                                      <Avatar
                                        className={
                                          classes.participantTweetAvatar
                                        }
                                        src={
                                          message.tweet.user.avatar?.src
                                            ? message.tweet.user.avatar.src
                                      ...
                                      <span
                                        className={
                                          classes.participantTweetFullName
                                        }
                                      >
                                        {message.tweet.user.fullName}
                                      </span>
                                      <span
                                        className={
                                          classes.participantTweetUsername
                                        }
                                      >
                                        @{message.tweet.user.username}
                                      </span>
