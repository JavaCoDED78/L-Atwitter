...
(
    user_id                  int8 not null,
    not_interested_topics_id int8 not null
);
...
alter table if exists users_not_interested_topics
    add constraint UK_gr8olpyfdn3tcps798pnqehtg unique (not_interested_topics_id);
...
alter table if exists topic_followers
    add constraint FKokvmqpsgt4fhvbk7mrev8meoy foreign key (users_id) references users;
alter table if exists topic_followers
    add constraint FKey0h2wj87rva5yrnx6hbq4320 foreign key (topics_id) references topics;
...
alter table if exists users_not_interested_topics
    add constraint FKt3cr591d3b78fo7dkk85jk6ba foreign key (user_id) references users;
