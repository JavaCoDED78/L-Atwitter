...
public class TestConstants {
    ...
    public static final String URL_AUTH_REGISTRATION = URL_AUTH_BASIC + "/registration";
    public static final String URL_AUTH_FORGOT = URL_AUTH_BASIC + "/forgot";
    public static final String URL_AUTH_RESET = URL_AUTH_BASIC + "/reset";
    ...
    public static final String BIRTHDAY = "Mar 14, 1978";
    public static final String USER_EMAIL = "androsor99@gmail.com";
    ...
    public static final String REGISTRATION_DATE = "2023-09-01T23:34:32";
