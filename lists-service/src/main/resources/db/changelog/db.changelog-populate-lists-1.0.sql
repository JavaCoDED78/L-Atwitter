...
INSERT INTO lists (id, alt_wallpaper, description, private, name, list_owner_id, wallpaper) VALUES (2, 'https://pbs.twimg.com/media/EXZ2w_qUcAMwN3x?format=png&name=small', 'Some description', false, 'Some some', 1, null);
...
--rollback TRUNCATE lists_members
