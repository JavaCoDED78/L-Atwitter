...
public class ListsControllerTest {
    ...
    public void getAllTweetLists() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(TestConstants.URL_LISTS_BASIC))
                ...
                .andExpect(jsonPath("$[0].pinnedDate").value(TestConstants.LIST_PINNED_DATE))
    ...
    public void getUserTweetLists() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/user"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(3)))
    ...
    public void getUserTweetListsById() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/user/2"))
                .andExpect(status().isOk())
    ...
    public void getTweetListsWhichUserIn() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/user/consist"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
    ...
    public void getUserPinnedLists() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/pined"))
                .andExpect(status().isOk())
    ...
    public void getListById() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/4"))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.pinnedDate").value(TestConstants.LIST_PINNED_DATE))
    ...
    public void getOwnerPrivateListById() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/6"))
                .andExpect(status().isOk())
    ...
    public void getFollowedPrivateListById() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/7"))
                .andExpect(status().isOk())
    ...
    public void getPrivateListById_NotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/8"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void getListById_NotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/99"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void createTweetList() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(TestConstants.URL_LISTS_BASIC)
    ...
    public void createTweetList_ShouldListNameLengthIs0() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(TestConstants.URL_LISTS_BASIC)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Incorrect list name length")));
    }
    ...
    public void editTweetList() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put(TestConstants.URL_LISTS_BASIC)
                        .content(mapper.writeValueAsString(listsRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
    ...
    public void editTweetList_ShouldListNotFound() throws Exception {
        ...
        userResponse.setId(TestConstants.USER_ID);
        ListsRequest listsRequest = new ListsRequest();
    ...
    public void editTweetList_ShouldListOwnerNotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put(TestConstants.URL_LISTS_BASIC)
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List owner not found")));
    }
    ...
    public void deleteList() throws Exception {
        mockMvc.perform(delete(TestConstants.URL_LISTS_BASIC + "/4"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List id:4 deleted.")));
    }
    ...
    public void deleteList_ShouldNotFound() throws Exception {
        mockMvc.perform(delete(TestConstants.URL_LISTS_BASIC + "/99"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void deleteAnotherUserList_ShouldNotFound() throws Exception {
        mockMvc.perform(delete(TestConstants.URL_LISTS_BASIC + "/5"))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List owner not found")));
    }
    ...
    public void followList() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/follow/9"))
                .andExpect(status().isOk())
    ...
    public void followList_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/follow/99"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void followList_ShouldFollowToPrivateListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/follow/8"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void unfollowList() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/follow/4"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.name").value(TestConstants.LIST_NAME))
                .andExpect(jsonPath("$.description").value(TestConstants.LIST_DESCRIPTION))
    ...
    public void pinList() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/pin/6"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(6))
                .andExpect(jsonPath("$.name").value(TestConstants.LIST_NAME))
                .andExpect(jsonPath("$.pinnedDate").isEmpty())
    ...
    public void pinList_ShouldPinnedListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/pin/8"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void getListsToAddUser() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/add/user/1"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(2)))
    ...
    public void unpinList() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/pin/4"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.name").value(TestConstants.LIST_NAME))
                .andExpect(jsonPath("$.pinnedDate").isEmpty())
    ...
    public void addUserToLists() throws Exception {
        ...
        mockMvc.perform(post(TestConstants.URL_LISTS_BASIC + "/add/user")
    ...
    public void addUserToLists_ShouldUserIsBlocked() throws Exception {
        ...
        mockMvc.perform(post(TestConstants.URL_LISTS_BASIC + "/add/user")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("User with ID:4 is blocked")));
    }
    ...
    public void addUserToLists_ShouldUserBlockedMyProfile() throws Exception {
        ...
        mockMvc.perform(post(TestConstants.URL_LISTS_BASIC + "/add/user")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("User with ID:2 is blocked")));
    }
    ...
    public void addUserToList() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/add/user/1/6"))
                .andExpect(status().isOk())
    ...
    public void addUserToList_ShouldUserIsBlocked() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/add/user/4/6"))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("User with ID:4 is blocked")));
    }
    ...
    public void addUserToList_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/add/user/3/6"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("User not found")));
    }
    ...
    public void addUserToList_ShouldUserBlockedMyProfile() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/add/user/6/6"))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("User with ID:2 is blocked")));
    }
    ...
    public void addUserToList_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/add/user/7/99"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void removeUserFromList() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/add/user/1/4"))
                .andExpect(status().isOk())
    ...
    public void getTweetsByListId() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/4/tweets"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
    ...
    public void getTweetsByUserPrivateListId() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/5/tweets"))
                .andExpect(status().isOk())
    ...
    public void getListDetails() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/4/details"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.name").value(TestConstants.LIST_NAME))
                .andExpect(jsonPath("$.description").value(TestConstants.LIST_DESCRIPTION))
    ...
    public void getListDetailsByUserPrivateList() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/5/details"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void getListFollowers() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/4/2/followers"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
    ...
    public void getListFollowers_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/99/2/followers"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void getListFollowers_ByPrivateListShouldListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/5/1/followers"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void getListFollowers_ByBlockedUserAndListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/10/5/followers"))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("User with ID:2 is blocked")));
    }
    ...
    public void getListMembers() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/4/2/members"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(1L))
                .andExpect(jsonPath("$[0].fullName").value(TestConstants.USERNAME2))
    ...
    public void getListMembersByAnotherUser() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/9/1/members"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(1L))
                .andExpect(jsonPath("$[0].fullName").value(TestConstants.USERNAME2))
    ...
    public void getListMembers_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/99/2/members"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void getListMembers_ByPrivateListShouldListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/5/1/members"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("List not found")));
    }
    ...
    public void getListMembers_ByBlockedUserAndListNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/10/5/members"))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("User with ID:2 is blocked")));
    }
    ...
    public void searchListMembersByUsername() throws Exception {
        mockMvc.perform(get(TestConstants.URL_LISTS_BASIC + "/search/2/MrCat"))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$[0].avatar.id").value(TestConstants.AVATAR_ID))
                .andExpect(jsonPath("$[0].isPrivateProfile").value(false))
