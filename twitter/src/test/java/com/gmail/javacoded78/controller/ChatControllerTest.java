...
public class ChatControllerTest {
    ...
    public void getChatById() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/8"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").isNotEmpty())
                .andExpect(jsonPath("$.creationDate").isNotEmpty())
                .andExpect(jsonPath("$.participants").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.participants[*]", Matchers.hasSize(2)))
    ...
    public void getUserChats() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/users"))
                .andExpect(status().isOk())
    ...
    public void createChat() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/create/3"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").isNotEmpty())
                .andExpect(jsonPath("$.creationDate").isNotEmpty())
                .andExpect(jsonPath("$.participants").isNotEmpty())
    ...
    public void createChat_ShouldParticipantNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/create/111"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Participant not found")));
    }
    ...
    public void createChat_BadRequest() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/create/4"))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Participant is blocked")));
    }
    ...
    public void getChatMessages() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/8/messages"))
                .andExpect(status().isOk())
    ...
    public void readChatMessages() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/8/read/messages"))
                .andExpect(status().isOk())
    ...
    public void addMessage() throws Exception {
        ...
        request.setText(TestConstants.TEST_TWEET_TEXT);

        mockMvc.perform(post(TestConstants.URL_CHAT_BASIC + "/add/message")
    ...
    public void addMessage_ChatNotFound() throws Exception {
        ...
        mockMvc.perform(post(TestConstants.URL_CHAT_BASIC + "/add/message")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Chat not found")));
    }
    ...
    public void addMessage_ChatParticipantNotFound() throws Exception {
        ...
        mockMvc.perform(post(TestConstants.URL_CHAT_BASIC + "/add/message")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Chat participant not found")));
    }
    ...
    public void addMessageWithTweet() throws Exception {
        ...
        mockMvc.perform(post(TestConstants.URL_CHAT_BASIC + "/add/message/tweet")
                        .content(mapper.writeValueAsString(request))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").isNotEmpty())
    ...
    public void getParticipant() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/participant/4/8"))
                .andExpect(status().isOk())
    ...
    public void getParticipant_ChatNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/participant/4/11"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Chat not found")));
    }
    ...
    public void getParticipant_ParticipantNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/participant/5/8"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Participant not found")));
    }
    ...
    public void leaveFromConversation() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/leave/3/8"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Successfully left the chat")));
    }
    ...
    public void leaveFromConversationAndDeleteChat() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/leave/5/10"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Chat successfully deleted")));
    }
    ...
    public void leaveFromConversation_ParticipantNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/leave/10/10"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Participant not found")));
    }
    ...
    public void leaveFromConversation_ChatNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_CHAT_BASIC + "/leave/2/9"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Chat not found")));
    }
}