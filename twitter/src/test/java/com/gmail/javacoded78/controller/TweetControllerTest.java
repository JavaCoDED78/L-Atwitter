...
public class TweetControllerTest {
    ...
    public void getTweetById_ShouldNotFound() throws Exception {
        mockMvc.perform(get(URL_TWEETS_BASIC + "/99"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Tweet not found")));
    }
    ...
    public void getTweetById_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(get(URL_TWEETS_BASIC + "/49"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Sorry, that Tweet has been deleted.")));
    }
    ...
    @Test
    @WithUserDetails(USER_EMAIL)
    @DisplayName("[200] GET /api/v1/tweets/40/quotes - Get Quotes By Tweet Id")
    public void getQuotesByTweetId() throws Exception {
        mockMvc.perform(get(URL_TWEETS_BASIC + "/40/quotes"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
                ...
                .andExpect(jsonPath("$[0].user.id").value(1L))
                .andExpect(jsonPath("$[0].poll").isEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*].images", Matchers.hasSize(1)))
    ...
    @Test
    @WithUserDetails(USER_EMAIL)
    @DisplayName("[200] GET /api/v1/tweets/40/liked-users - Get Liked Users By Tweet Id")
    public void getLikedUsersByTweetId() throws Exception {
        mockMvc.perform(get(URL_TWEETS_BASIC + "/40/liked-users"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
    ...
    @Test
    @WithUserDetails(USER_EMAIL)
    @DisplayName("[200] GET /api/v1/tweets/40/retweeted-users - Get Retweeted Users By Tweet Id")
    public void getRetweetedUsersByTweetId() throws Exception {
        mockMvc.perform(get(URL_TWEETS_BASIC + "/40/retweeted-users"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(1L))
                .andExpect(jsonPath("$[0].fullName").value(USERNAME2))
    ...
    public void createTweet_ShouldTweetTextLengthMoreThan280Symbols() throws Exception {
        ...
        mockMvc.perform(post(URL_TWEETS_BASIC)
                ...
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Incorrect tweet text length")));
    }
    ...
    public void createTweetWithPoll_ShouldIncorrectPoolChoicesSizeIs1() throws Exception {
        ...
        mockMvc.perform(post(URL_TWEETS_BASIC + "/poll")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Incorrect poll choices")));
    }
    ...
    public void createTweetWithPoll_ShouldIncorrectPoolChoicesTextLengthIs0() throws Exception {
        ...
        mockMvc.perform(post(URL_TWEETS_BASIC + "/poll")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Incorrect choice text length")));
    }
    ...
    public void deleteScheduledTweets() throws Exception {
        ...
        mockMvc.perform(delete(URL_TWEETS_BASIC + "/schedule")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Scheduled tweets deleted.")));
    }
    ...
    public void deleteTweet() throws Exception {
        mockMvc.perform(delete(URL_TWEETS_BASIC + "/40"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Your Tweet was deleted")));
    }
    ...
    public void searchTweets() throws Exception {
        mockMvc.perform(get(URL_TWEETS_BASIC + "/search/test"))
                ...
                .andExpect(jsonPath("$[0].user.id").value(1L))
                .andExpect(jsonPath("$[0].poll").isEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$[*].images", Matchers.hasSize(4)))
                .andExpect(jsonPath("$[0].retweetsCount").value(1L))
                .andExpect(jsonPath("$[0].likedTweetsCount").value(1L))
                .andExpect(jsonPath("$[0].repliesCount").value(0L))
                .andExpect(jsonPath("$[0].isTweetLiked").value(true))
    ...
    public void voteInPoll_ShouldPollNotFound() throws Exception {
        ...
        mockMvc.perform(post(URL_TWEETS_BASIC + "/vote")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Poll not found")));
    }
    ...
    public void voteInPoll_ShouldPollChoiceNotFound() throws Exception {
        ...
        mockMvc.perform(post(URL_TWEETS_BASIC + "/vote")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Poll choice not found")));
    }
    ...
    public void voteInPoll_ShouldPollInTweetNotFound() throws Exception {
        ...
        mockMvc.perform(post(URL_TWEETS_BASIC + "/vote")
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is("Poll in tweet not exist")));
    }
