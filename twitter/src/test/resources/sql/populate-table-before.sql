...
VALUES (1,
        'https://twitterclonestorage.s3.eu-central-1.amazonaws.com/0a6c735d-def8-4587-a29f-221915ef6cb4_ff2d023b3220f93bbc79233614dea542.jpg');
INSERT INTO images (id, src)
VALUES (11,
        'https://twitterclonestorage.s3.eu-central-1.amazonaws.com/ae83099c-885b-499a-bb6f-5e34e1b69e7d_4ec7201fd370bd9870cdb326f0511f38.jpg');
INSERT INTO images (id, src)
VALUES (22,
        'https://twitterclonestorage.s3.eu-central-1.amazonaws.com/dfc8a223-45fc-43da-8b7c-f76e2c2507cd_82ecbca14eb4999212c07257f41c70e7.jpg');
INSERT INTO images (id, src)
VALUES (33,
        'https://twitterclonestorage.s3.eu-central-1.amazonaws.com/348b7dbe-3ac5-477f-8483-edc24f53091b_814370.jpg');
INSERT INTO images (id, src)
VALUES (44,
        'https://twitterclonestorage.s3.eu-central-1.amazonaws.com/d0e5b95f-acc0-47ef-b499-477f7e5a1a06_PrMnWa2z.jpg');
...
VALUES (2, 'Hello twitter!', null, true, 'Mar 10, 1991', 'test2015@test.test', 'MrCat', 'New York', 3,
        '$2a$08$1D3LToUL9ccJYqGDZNPH8uvTBwVFou5MobYvtgAakra6WdACQZWJK', null, true, true, '2021-08-01 23:34:32.000000',
        'USER', 126, 'MrCat', 'https://www.google.com', 40, 44, 'UA', 'Cat', 'Ukrainian - українська', true, 666966623,
        false, 'UA', 'DEFAULT', 'BLUE');
INSERT INTO users (id, about, activation_code, active, birthday, email, full_name, location, notifications_count,
                   password, password_reset_code, profile_customized, profile_started, registration_date, role,
                   tweet_count, username, website, like_count, media_tweet_count, country, gender, language,
                   muted_direct_messages, phone, private_profile, country_code, background_color, color_scheme)
VALUES (3, 'Hello twitter!', '1234567890', true, 'Mar 10, 1991', 'test2016@test.test', 'MrCat', 'New York', 3,
        ...
        '2021-08-01 23:34:32.000000', 'USER', 126, 'MrCat', 'https://www.google.com', 40, 44, 'UA', 'Cat',
...
INSERT INTO tweets (id, addressed_id, addressed_tweet_id, addressed_username, date_time, reply_type, text, users_id,
                    link, link_cover, link_description, link_title, link_cover_size, scheduled_date, deleted)
VALUES (49, null, null, null, '2021-10-03 20:40:51.000000', 'EVERYONE', 'hello world3', 2, null, null, null, null, null,
        null, true);
...
-- user_wallpaper
INSERT INTO user_wallpaper (user_id, wallpaper_id)
VALUES (1, 22);
INSERT INTO user_wallpaper (user_id, wallpaper_id)
VALUES (2, 44);
INSERT INTO user_wallpaper (user_id, wallpaper_id)
...
VALUES (80, '2021-10-03 20:31:44.000000', 40, 1);
INSERT INTO like_tweets (id, like_tweet_date, tweets_id, users_id)
VALUES (81, '2021-10-03 20:31:44.000000', 45, 2);

-- retweets
INSERT INTO retweets (id, retweet_date, tweets_id, users_id)
VALUES (8, '2021-10-03 20:31:47.000000', 40, 1);
INSERT INTO retweets (id, retweet_date, tweets_id, users_id)
VALUES (9, '2021-10-03 20:31:47.000000', 45, 2);
...
VALUES (2, '2021-10-03 20:35:53.000000', 40, 2);

-- chats
INSERT INTO chats (id, creation_date)
VALUES (8, '2021-10-03 20:29:55.000000');
INSERT INTO chats (id, creation_date)
VALUES (10, '2021-10-03 20:29:55.000000');
...
VALUES (4, 'https://pbs.twimg.com/media/EXZ2rMvVAAAAfrN?format=png&name=small', 'test list description', false,
        'test list name', 2, null, '2021-10-03 20:42:53.000000');
INSERT INTO lists (id, alt_wallpaper, description, private, name, user_id, wallpaper_id, pinned_date)
VALUES (5, 'https://pbs.twimg.com/media/EXZ2rMvVAAAAfrN?format=png&name=small', 'test list description', true,
        'test list name', 1, null, '2021-10-03 20:42:53.000000');
INSERT INTO lists (id, alt_wallpaper, description, private, name, user_id, wallpaper_id, pinned_date)
VALUES (6, 'https://pbs.twimg.com/media/EXZ2rMvVAAAAfrN?format=png&name=small', 'test list description', true,
        'test list name', 2, null, '2021-10-03 20:42:53.000000');
INSERT INTO lists (id, alt_wallpaper, description, private, name, user_id, wallpaper_id, pinned_date)
VALUES (7, 'https://pbs.twimg.com/media/EXZ2rMvVAAAAfrN?format=png&name=small', 'test list description', true,
        'test list name', 1, null, '2021-10-03 20:42:53.000000');
INSERT INTO lists (id, alt_wallpaper, description, private, name, user_id, wallpaper_id, pinned_date)
...
VALUES (37, '2021-10-03 20:31:44.000000', 'LIKE', 40, 1, null, null, 2);
INSERT INTO notifications (id, date, notification_type, tweet_id, user_id, user_to_follow_id, list_id, notified_user_id)
VALUES (38, '2021-10-03 20:31:47.000000', 'RETWEET', 40, 1, null, null, 2);
INSERT INTO notifications (id, date, notification_type, tweet_id, user_id, user_to_follow_id, list_id, notified_user_id)
VALUES (39, '2021-10-03 20:37:12.000000', 'FOLLOW', null, 2, 1, null, 1);
INSERT INTO notifications (id, date, notification_type, tweet_id, user_id, user_to_follow_id, list_id, notified_user_id)
VALUES (40, '2021-10-03 20:37:20.000000', 'FOLLOW', null, 1, 2, null, 2);
INSERT INTO notifications (id, date, notification_type, tweet_id, user_id, user_to_follow_id, list_id, notified_user_id)
VALUES (41, '2021-10-03 20:38:51.000000', 'TWEET', 46, 2, null, null, null);
INSERT INTO notifications (id, date, notification_type, tweet_id, user_id, user_to_follow_id, list_id, notified_user_id)
VALUES (42, '2021-10-03 20:39:51.000000', 'TWEET', 47, 2, null, null, null);
INSERT INTO notifications (id, date, notification_type, tweet_id, user_id, user_to_follow_id, list_id, notified_user_id)
VALUES (43, '2021-10-03 20:40:51.000000', 'TWEET', 48, 2, null, null, null);
...
-- topic_followers
INSERT INTO topic_followers (topic_id, user_id)
VALUES (1008, 2);
INSERT INTO topic_followers (topic_id, user_id)
VALUES (1017, 2);
INSERT INTO topic_followers (topic_id, user_id)
...
INSERT INTO topic_not_interested (topic_id, user_id)
VALUES (1018, 2);
INSERT INTO topic_not_interested (topic_id, user_id)
VALUES (1019, 2);
